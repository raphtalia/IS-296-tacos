package tran.tacos.controllers;
...
import tran.tacos.repositories.CustomerReviewRepository;
...
public class CustomerReviewController {
    ...
    public ResponseEntity<CustomerReview> updateReview(@PathVariable("id") String id, @RequestBody CustomerReview review) {
        ...
        if (reviewData.isPresent()) {
            ...
            _review.setContactPhone(review.getContactPhone());
            _review.setContactEmail(review.getContactEmail());
            _review.setActionNeeded(review.isActionNeeded());

            customerReviewRepository.save(_review);
